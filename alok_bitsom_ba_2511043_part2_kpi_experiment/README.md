...
**Repository:** `alokverma_bitsom_ba_2511043_part2_kpi_experiment`  
...
```
alokverma_bitsom_ba_2511043_part2_kpi_experiment/
├── data/
...
| File | Description |
|---|---|
| `analysis/experiment_analysis.xlsx` | 4 sheets: Cleaned Data, Group Counts, Metric Calculations, Segment Analysis |
| `analysis/hypothesis_test_notes.md` | Full hypotheses, test outputs, interpretations |
| `outputs/kpi_tree.png` | Visual KPI hierarchy with North Star, drivers, sub-drivers, guardrails |
| `outputs/experiment_summary.xlsx` | All 12 metrics with Control/Treatment/Lift/Decision per row + Guardrail sheet |
| `outputs/recommendation_memo.md` | Executive-level launch decision memo |
...
| File | Description |
|---|---|
| `summary_metrics.png` | 6-panel bar chart comparison of key metrics |
| `hypothesis_test_output.png` | Z-test result panel + distribution + segment bars |
| `kpi_tree_preview.png` | Full KPI tree diagram |
